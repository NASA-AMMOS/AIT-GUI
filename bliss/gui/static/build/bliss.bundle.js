...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.util = exports.tlm = exports.time = exports.packets = exports.gui = exports.format = exports.events = undefined;
	...
	var _tlm = __webpack_require__(149);
	...
	function init() {
	    ready(function () {
	        ...
	        m.request({ url: '/tlm/dict' }).then(function (dict) {
	            bliss.tlm.dict = new _tlm.TelemetryDictionary(dict);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sprintfJs = __webpack_require__(14);

	var _strftime = __webpack_require__(15);
	...
	var Field = {
	    ...
	    view: function view(vnode) {
	        ...
	        if (bliss.tlm.dict !== undefined && bliss.tlm.streams[pname] === undefined) {
	            var url = '/tlm/realtime/' + pname + '/json';
	            var defn = bliss.tlm.dict[pname];
	        ...
	        if (value === undefined) {
	            ...
	            if (vnode.attrs.format) {
	                var _defn = packet._defn[this._name];
	                var type = _defn && _defn.type;

	                if (type && type.indexOf('TIME', 0) === 0) {
	                    var date = new Date(value * 1000 + 315964800000);
	                    value = _strftime.strftime.utc()(vnode.attrs.format, date);
	                } else {
	                    value = (0, _sprintfJs.sprintf)(vnode.attrs.format, value);
	                }
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _times = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRange = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseRange = __webpack_require__(21),
	    isIterateeCall = __webpack_require__(22),
	    toFinite = __webpack_require__(35);
...
/***/ function(module, exports) {
	...
	var FieldDefinition = function () {
	    function FieldDefinition(args) {
	        ...
	        if (this.format.length > 0 && this.format[0] === '<' || this.format[0] === '>') {
	    ...
	    _createClass(FieldDefinition, [{
	        ...
	        value: function decode(view) {
	            ...
	            switch (this.format) {
	                case 'b':
	                    value = view.getInt8(this.offset, this.le);break;
	                case 'B':
	                    value = view.getUint8(this.offset, this.le);break;
	                case 'h':
	                    value = view.getInt16(this.offset, this.le);break;
	                case 'H':
	                    value = view.getUint16(this.offset, this.le);break;
	                case 'i':
	                    value = view.getInt32(this.offset, this.le);break;
	                case 'I':
	                    value = view.getUint32(this.offset, this.le);break;
	                case 'f':
	                    value = view.getFloat32(this.offset, this.le);break;
	                case 'd':
	                    value = view.getFloat64(this.offset, this.le);break;
	                default:
	                    break;
	            }
	...
	var Packet = function () {
	    function Packet(defn, data) {
	        ...
	        this._defn.fields.forEach(function (field) {
	            var getter = function getter() {
	                if (_this.data instanceof DataView) {
	                    return field.decode(_this.data);
	                } else {
	                    return _this.data[field.name];
	                }
	            };

	            Object.defineProperty(_this, field.name, { get: getter });
	        });
	    }
	...
	var PacketDefinition = function () {
	    function PacketDefinition(name, fields) {
	        ...
	        for (var key in fields) {
	            var defn = new FieldDefinition(fields[key]);
