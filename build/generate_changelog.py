...
url = API_HOSTNAME + 'repos/bliss/bliss-gui/issues?state=all&per_page=100&sort=updated'
if args['start_time']:
...
for issue in raw_issues:
    ...
    elif issue['labels'] and len([l for l in issue['labels'] if l['name'] in ['wontfix', 'duplicate']]) != 0:
        continue
