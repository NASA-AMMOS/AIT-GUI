...
## [2.5.4](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.5.2...2.5.4)

### Merged

- GHSA-x8ww-97rj-cx44: Adding additional js test and updating poetry lock [`#272`](https://github.com/NASA-AMMOS/AIT-GUI/pull/272)
- GHSA-x8ww-97rj-cx44: Fixing unit test, updating to use actual ait-cor… [`#271`](https://github.com/NASA-AMMOS/AIT-GUI/pull/271)

## [2.5.3](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.5.2...2.5.3)

### Merged

- Fix GHSA-x8ww-97rj-cx44: SonarCloud and Security Improvements [`#271`](https://github.com/NASA-AMMOS/AIT-GUI/pull/271)
- Fix GHSA-x8ww-97rj-cx44: Removing bind parms and checking against dmc [`#270`](https://github.com/NASA-AMMOS/AIT-GUI/pull/270)
- Fix Read the Docs build issues [`#269`](https://github.com/NASA-AMMOS/AIT-GUI/pull/269)

### Security

- Fix GHSA-x8ww-97rj-cx44: Additional security improvements and SonarCloud compliance
  - Removed unused bind parameters
  - Enhanced security test coverage with improved unit tests
  - Updated tests to use actual ait-core module instead of conftest fixtures
  - Cleaned up unused test code

### Fixed

- Fixed Read the Docs build configuration and Sphinx JSDoc integration
  - Updated readthedocs.yml to latest syntax
  - Added jsdoc.json configuration for better documentation generation
  - Fixed Sphinx configuration for proper JavaScript documentation

### Commits

- GHSA-x8ww-97rj-cx44: Fixing unit test, updating to use actual ait-core module [`67b3b01`](https://github.com/NASA-AMMOS/AIT-GUI/commit/67b3b01a)
- GHSA-x8ww-97rj-cx44: Removing bind parms and checking against dmc instead [`cc0c9e4`](https://github.com/NASA-AMMOS/AIT-GUI/commit/cc0c9e48)
- Updates to fix sphinx jsdoc and readthedocs [`2413574`](https://github.com/NASA-AMMOS/AIT-GUI/commit/2413574c)
- Clean-up unused tests [`247c65e`](https://github.com/NASA-AMMOS/AIT-GUI/commit/247c65e5)
- ghsa-x8ww-97rj-cx44: SonarCloud and Security Improvements [`27dc1cd`](https://github.com/NASA-AMMOS/AIT-GUI/commit/27dc1cd6)

## [2.5.2](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.5.1...2.5.2)

### Security

- Fix GHSA-p9r8-2q67-fp86: unauthenticated remote command/script/sequence
  execution and path traversal in the GUI web API.
  - The web server now binds the configured `host` (default `localhost`)
    instead of the hard-coded `0.0.0.0`. **Operators who need remote access
    must now set `host` explicitly in the GUI plugin configuration.**
  - State-changing endpoints (POST/PUT/DELETE/PATCH) now reject cross-origin
    browser requests via a same-origin (`Origin`/`Referer` vs `Host`) check,
    mitigating CSRF. Non-browser clients that send neither header are
    unaffected.
  - `/script/run` and `/seq` now confine the requested path to `ScriptRoot`
    and `SEQRoot` respectively (canonicalize + `is_relative_to`), matching the
    existing `/scripts/load` check, preventing path traversal.
  - Added `tests/test_gui_security.py` regression coverage for all three fixes.

## [2.5.1](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.5.0...2.5.1)

### Commits

- Restrict script execution paths and avoid static temp files [`beb8fc0`](https://github.com/NASA-AMMOS/AIT-GUI/commit/beb8fc0813eded89f985d3eb9a73535dd327726d)
- Adding noqa for long string [`4706512`](https://github.com/NASA-AMMOS/AIT-GUI/commit/470651292d1a2b41acb6129f6d2f23103c18473b)

## [2.5.0](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.5.0-rc1...2.5.0)

### Merged

- Issue #264: Restricting python version and removing pkg_resources [`#265`](https://github.com/NASA-AMMOS/AIT-GUI/pull/265)
- Issue #264: Adding sonarqube changes [`#266`](https://github.com/NASA-AMMOS/AIT-GUI/pull/266)

### Commits

- Updates to support python 3.12 - AWS Transform [`bd0e3ca`](https://github.com/NASA-AMMOS/AIT-GUI/commit/bd0e3cac4e7a3b1c27568054ab5beb298ebb517d)
- Issue-264: Restricting python version and removing pkg_resources [`60e1152`](https://github.com/NASA-AMMOS/AIT-GUI/commit/60e11520f62e9e7a75f5a107db6b714620ff4869)
- Issue #264: Pick up the config files properly [`adde2f7`](https://github.com/NASA-AMMOS/AIT-GUI/commit/adde2f7e2e2aa750cfec2faec110285355091b1c)
- Issue #264: Fixing sonarqube check - safe handling with path [`dbd4ec2`](https://github.com/NASA-AMMOS/AIT-GUI/commit/dbd4ec2b5d4bb5329d62d6708ab344fdcd20aa13)
- Issue #264: Review changes [`f7fb006`](https://github.com/NASA-AMMOS/AIT-GUI/commit/f7fb006a44481616fbf133496da6307716c8063f)
- Issue #264: Consistency with python version req [`91d922b`](https://github.com/NASA-AMMOS/AIT-GUI/commit/91d922bd102c8622b3611df9be93ef84ff395ba1)

## [2.5.0-rc1](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.4.1...2.5.0-rc1) - 2025-06-17

### Merged

- Issue #261 - Remove pickle from AIT-GUI [`#263`](https://github.com/NASA-AMMOS/AIT-GUI/pull/263)

## [2.4.1](https://github.com/NASA-AMMOS/AIT-GUI/compare/2.4.0...2.4.1) - 2023-07-26

### Commits

- Prep for 2.4.1 [`ac75c76`](https://github.com/NASA-AMMOS/AIT-GUI/commit/ac75c7672273418aa1e4f8f560d967086d39c7e3)
